...
from .phc_isaaclab_marl_env_cfg import PhcIsaaclabMarlEnvCfg


class PhcIsaaclabMarlEnv(DirectMARLEnv):
    cfg: PhcIsaaclabMarlEnvCfg

    def __init__(self, cfg: PhcIsaaclabMarlEnvCfg, render_mode: str | None = None, **kwargs):
