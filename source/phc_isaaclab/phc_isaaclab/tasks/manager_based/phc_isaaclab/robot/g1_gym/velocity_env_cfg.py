...
from phc_isaaclab.assets.robots.unitree import UNITREE_G1_12DOF_CFG as ROBOT_CFG
from phc_isaaclab.tasks.manager_based.phc_isaaclab.robot.g1_gym import mdp
