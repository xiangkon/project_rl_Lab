...
class SmplxLite(nn.Module):
    def __init__(
        self,
        model_path="asserts/gvhmr_inputs/checkpoints/body_models/smplx",
        gender="neutral",
        num_betas=10,
    ):
        super().__init__()
...
class SmplxLiteCoco17(SmplxLite):
    ...
    def __init__(self, **kwargs):
        ...
        # Compute mapping
        smplx2smpl = torch.load("source/gvhmr/hmr4d/utils/body_model/smplx2smpl_sparse.pt")
        COCO17_regressor = torch.load("source/gvhmr/hmr4d/utils/body_model/smpl_coco17_J_regressor.pt")
...
class SmplxLiteV437Coco17(SmplxLite):
    def __init__(self, **kwargs):
        ...
        # Verts437
        smplx_vids2 = torch.load("source/gvhmr/hmr4d/utils/body_model/smplx_verts437.pt")
...
class SmplxLiteSmplN24(SmplxLite):
    ...
    def __init__(self, **kwargs):
        ...
        # Compute mapping
        smplx2smpl = torch.load("source/gvhmr/hmr4d/utils/body_model/smplx2smpl_sparse.pt")
        smpl2joints = torch.load("source/gvhmr/hmr4d/utils/body_model/smpl_neutral_J_regressor.pt")
