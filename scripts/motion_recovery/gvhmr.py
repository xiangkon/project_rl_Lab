...
def parse_args_to_cfg():
    ...
    parser.add_argument("--video", type=str, default="/home/hdh/work/project_rl_Lab/asserts/video/kun.mp4")
    parser.add_argument("--output_root", type=str, default="outputs/pipeline/gvhmr", help="by default to outputs/demo")
...
def render_incam(cfg):
    ...
    smplx2smpl = torch.load("source/gvhmr/hmr4d/utils/body_model/smplx2smpl_sparse.pt").cuda()
...
def render_global(cfg):
    ...
    smplx2smpl = torch.load("source/gvhmr/hmr4d/utils/body_model/smplx2smpl_sparse.pt").cuda()
    faces_smpl = make_smplx("smpl").faces
    J_regressor = torch.load("source/gvhmr/hmr4d/utils/body_model/smpl_neutral_J_regressor.pt").cuda()
